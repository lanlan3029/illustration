...
export default {
    data(){
        return{
          ...
          {type:"background",icon:'iconfont icon-tupian',id:1,num:2},
          {type:"scene",icon:'iconfont icon-scene',id:2,num:2},
          {type:"textbox",icon:'iconfont icon-text_box',id:3,num:2},
          {type:"people",icon:'iconfont icon-renti',id:4,num:2},
          {type:"animal",icon:'iconfont icon--panda',id:5,num:2},
          {type:"plant",icon:'iconfont icon-shu3',id:6,num:2},
          {type:"food",icon:'iconfont icon-shiwu-2',id:7,num:2},
          {type:"toy",icon:'iconfont icon-jimu2',id:8,num:2},
          {type:"vehicle",icon:'iconfont icon-qichepiao',id:9,num:2},
          {type:"decoration",icon:'iconfont icon-zhuangshipin',id:10,num:2},
          {type:"furniture",icon:'iconfont icon-shafa1',id:11,num:2},
          {type:"others",icon:'iconfont icon-other',id:12,num:2}],
          pictureArr:[],
          page:1,
          hasMore:true,
          loading:false,
