...
// API
import { getTmplList, getFileTypeTree } from '@/components/editorPro/api/user';
// 素材与分页
import useMaterial from '@/components/editorPro/hooks/useMaterial';
import usePageList, { getMaterialInfoUrl, getMaterialPreviewUrl } from '@/components/editorPro/hooks/usePageList';
// 路由
