...
import { uiType, paramsFilters, combinationFilters } from './filters/filter.js';
...
// 图片地址拼接（当前项目没有 filters 预览图，占位返回空字符串）
