...
// 左侧具体面板组件，全部来自已复制的 editor-components 目录
import importTmpl from '@/components/editorPro/editor-components/importTmpl.vue'
import fontStyle from '@/components/editorPro/editor-components/fontStyle.vue'
...
// 菜单配置，name 使用 computed 包装 i18n 文案，保持响应式
